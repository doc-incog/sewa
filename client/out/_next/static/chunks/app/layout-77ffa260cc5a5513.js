 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let o=(0,a.createContext)({}),i=()=>(0,a.useContext)(o),c=(0,a.forwardRef)((e,r)=>{var t,o,c;let{color:u,size:d,strokeWidth:h,absoluteStrokeWidth:m,className:f="",children:p,iconNode:x,...w}=e,{size:b=24,strokeWidth:v=2,absoluteStrokeWidth:g=!1,color:_="currentColor",className:k=""}=null!==(t=i())&&void 0!==t?t:{},y=(null!=m?m:g)?24*Number(null!=h?h:v)/Number(null!=d?d:b):null!=h?h:v;return(0,a.createElement)("svg",{ref:r,...n,width:null!==(o=null!=d?d:b)&&void 0!==o?o:n.width,height:null!==(c=null!=d?d:b)&&void 0!==c?c:n.height,stroke:null!=u?u:_,strokeWidth:y,className:(0,l.z)("lucide",k,f),...!p&&!s(w)&&{"aria-hidden":"true"},...w},[...x.map(e=>{let[r,t]=e;return(0,a.createElement)(r,t)}),...Array.isArray(p)?p:[p]])})},2228:function(e,r,t){"use strict";t.d(r,{Z:function(){return c}});var a=t(2265),n=t(103);/**
 * @license lucide-react v1.25.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let a=function(){for(var e=arguments.length,r=Array(e),t=0;t<e;t++)r[t]=arguments[t];return r.filter((e,r,t)=>!!e&&""!==e.trim()&&t.indexOf(e)===r).join(" ").trim()}}},function(e){e.O(0,[887,726,971,23,744],function(){return e(e.s=9666)}),_N_E=e.O()}]);